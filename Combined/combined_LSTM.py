...
class LSTMAutoencoder(nn.Module):
    ...
    def preprocess_state_sequence(self, state_sequence):
        ...
        # print(f"input_data: {data_in_tensor.shape}")
        # print(f"unsqueezed_data: {unsqueezed_data.shape}")
    ...
    def get_novelty(self, state_sequence):
        ...
        with torch.no_grad():
            ...
            # print(f"loss_list: {np.array(loss_list).shape}")
