...
class MazeEnv(GoalEnv):
    ...
    def reset(
        ...
        *,
        ...
        #This
        self.prev_pos = self.reset_pos.copy()
    ...
    def compute_reward(
        ...
        #This
        #position_change = abs(np.linalg.norm(self.prev_pos - achieved_goal, axis=-1))
        #self.prev_pos = achieved_goal.copy()
        reward = self.prev_dist - distance
        self.prev_dist = distance
        if self.reward_type == "dense":
            return 1 - distance/5  #Linear reward
            #return 2 * reward   #Velocity reward
            #return np.exp(-distance) #Exponential reward
